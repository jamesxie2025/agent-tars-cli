...
CMD sh -c "agent-tars --ui --port 8080 \
  ...
  --browser.control dom \
  --browser '{\"headless\":\"new\",\"executablePath\":\"/usr/bin/chromium\",\"args\":[\"--headless=new\",\"--no-sandbox\",\"--disable-setuid-sandbox\",\"--disable-dev-shm-usage\",\"--disable-gpu\",\"--disable-software-rasterizer\"]}' \
